...
CREATE TABLE IF NOT EXISTS `vetautet`.`ticket_order_details_202502` (
 ...
 created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation timestamp',
 PRIMARY KEY (id) USING BTREE,
--  FOREIGN KEY (order_number) REFERENCES ticket_order_202502(order_number) ON DELETE CASCADE,  -- match ticket_order_202502
...
-- 6. order_queue table
CREATE TABLE IF NOT EXISTS `vetautet`.`order_queue` (
